...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.mailinglist_address'
        db.add_column(u'team_team', 'mailinglist_address',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.mailinglist_address'
        db.delete_column(u'team_team', 'mailinglist_address')

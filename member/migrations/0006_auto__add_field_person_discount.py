...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.discount'
        db.add_column(u'member_person', 'discount',
                      self.gf('django.db.models.fields.CharField')(default='1NO', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.discount'
        db.delete_column(u'member_person', 'discount')

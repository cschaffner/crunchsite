...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.email'
        db.delete_column(u'member_job', 'email')


    def backwards(self, orm):
        # Adding field 'Job.email'
        db.add_column(u'member_job', 'email',
                      self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75, null=True, blank=True),
                      keep_default=False)

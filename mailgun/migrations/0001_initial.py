...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Email'
        db.create_table(u'mailgun_email', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('list', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['member.Job'], null=True, blank=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['team.Team'], null=True, blank=True)),
        ))
        db.send_create_signal(u'mailgun', ['Email'])


    def backwards(self, orm):
        # Deleting model 'Email'
        db.delete_table(u'mailgun_email')

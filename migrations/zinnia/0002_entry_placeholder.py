...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.content_placeholder'
        db.add_column(u'zinnia_entry', 'content_placeholder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.content_placeholder'
        db.delete_column(u'zinnia_entry', 'content_placeholder_id')
